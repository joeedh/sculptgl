class StateMultiresolution {
  ...
  static get SUBDIVISION() {
    return 0;
  } // subdivision of the mesh
  static get REVERSION() {
    return 1;
  } // reversion of the mesh
  static get SELECTION() {
    return 2;
  } // change selection of resolution
  static get DELETE_LOWER() {
    return 3;
  } // deletes lower resolution
  static get DELETE_HIGHER() {
    return 4;
  } // deletes higher resolution
  ...
  undo() {
    ...
    switch (this._type) {
      ...
      case StateMultiresolution.SUBDIVISION:
      case StateMultiresolution.REVERSION:
        let nbVerts = this._mesh.getNbVertices();
